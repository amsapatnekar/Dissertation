...
if __name__ == '__main__':
    ...
    parser.add_argument('--no-gaps', dest='gaps', action='store_false',
                    help='Disable gap insertion (overrides --gaps)')

    parser.add_argument('--linebreak', dest='linebreak', action='store_true',
                    help='Write fasta file with linebreak for sequences at 80 column width. ' +
                         'Default: no linebreaks')
    parser.add_argument('--no-linebreak', dest='linebreak', action='store_false',
                    help='Disable linebreaks (overrides --linebreak)')
